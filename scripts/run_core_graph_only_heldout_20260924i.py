"""Run graph-only Core object consumption with a read-only held-out overlay."""
...
COURSE = Path(r"K:/pure_integer_ai_work/current_runs/core-graph-heldout-20260920r5/heldout_response_course.int.json")
MANIFEST = Path(r"K:/pure_integer_ai_work/current_runs/core-graph-heldout-20260920r5/heldout_manifest.json")
ROOT = Path(r"K:/pure_integer_ai_work/current_runs/core-graph-only-heldout-20260924i")
_ORIGINAL_RUNTIME = base.TrainedGenerationConnectorRuntime
_generator = None


class _CanonicalWithHeldout:
    def __init__(self, database: Path):
        self._canonical_context = _ORIGINAL_RUNTIME(database)
