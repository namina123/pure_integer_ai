...
$runRoot = 'K:\pure_integer_ai_work\current_runs\core-graph-only-heldout-20260924j'; $control = 'K:\pure_integer_ai_work\orchestration\core-graph-only-heldout-20260924j-control'; $state = Join-Path $control 'state.json'; $stdout = Join-Path $control 'stdout.txt'; $stderr = Join-Path $control 'stderr.txt'
