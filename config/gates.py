...
live-read：模块级 bool·读即当前值·测试可 `gates.X = True` 翻·env `pure_integer_ai_<NAME>=1/0` 覆盖。
"""
...
DISPATCH_MODE = _flag("pure_integer_ai_DISPATCH_MODE", False)
...
A2_MODE = _flag("pure_integer_ai_A2_MODE", False)

# A3 PR wrapper（A3PRWrapper build/solve·dag_path 无条件调）。
# gate 装饰位保留位（机制不读 gate·零 getattr·无条件跑·同 JUDGE_MODE 承重件范式·OFF/ON 等价 bit-identical·gate 名定形避免后改）。
PR_MODE = _flag("pure_integer_ai_PR_MODE", False)
...
DISPATCH_TOKEN_CHAIN_MODE = _flag("pure_integer_ai_DISPATCH_TOKEN_CHAIN_MODE", False)
...
OUTPUT_WORD_REWARD_MODE = _flag("pure_integer_ai_OUTPUT_WORD_REWARD_MODE", False)
...
TEACHER_MODE = _flag("pure_integer_ai_TEACHER_MODE", False)

# Stage 6 消费：训练编排层（§十二五阶段 + oracle 标定 + promote + cursor 续训）。
# §六 end-state ON·OFF = 训练编排不接（单 episode 跑 bit-identical·无阶段门控）。
TRAINING_MODE = _flag("pure_integer_ai_TRAINING_MODE", False)
...
CUE_EXTRACTOR_MODE = _flag("pure_integer_ai_CUE_EXTRACTOR_MODE", False)
...
COOCCURS_WINDOW_MODE = _flag("pure_integer_ai_COOCCURS_WINDOW_MODE", False)
...
COOCCURS_DEDUP_MODE = _flag("pure_integer_ai_COOCCURS_DEDUP_MODE", False)
...
PRECEDES_DEDUP_MODE = _flag("pure_integer_ai_PRECEDES_DEDUP_MODE", False)
...
CAUSES_DEDUP_MODE = _flag("pure_integer_ai_CAUSES_DEDUP_MODE", False)
...
HOTZONE_MODE = _flag("pure_integer_ai_HOTZONE_MODE", False)
...
PRECEDES_OR_MODE = _flag("pure_integer_ai_PRECEDES_OR_MODE", False)
...
PRECEDES_OI_MODE = _flag("pure_integer_ai_PRECEDES_OI_MODE", False)
...
PRONOUN_INTRASEG_MODE = _flag("pure_integer_ai_PRONOUN_INTRASEG_MODE", False)
...
EMERGENT_RELATION_HYPOTHESIS_MODE = _flag("pure_integer_ai_EMERGENT_RELATION_HYPOTHESIS_MODE", False)
...
EMERGENT_RELATION_FEED_MODE = _flag("pure_integer_ai_EMERGENT_RELATION_FEED_MODE", False)
...
CAUSES_REWARD_DOMAIN_FILTER_MODE = _flag("pure_integer_ai_CAUSES_REWARD_DOMAIN_FILTER_MODE", False)
...
ACTION_EXPERIENCE_FEED_MODE = _flag("pure_integer_ai_ACTION_EXPERIENCE_FEED_MODE", False)
...
ACTION_INTENT_OVERRIDE_MODE = _flag("pure_integer_ai_ACTION_INTENT_OVERRIDE_MODE", False)
...
ACTION_SEED_BIAS_MODE = _flag("pure_integer_ai_ACTION_SEED_BIAS_MODE", False)
...
VALUE_SYNTHESIZE_MODE = _flag("pure_integer_ai_VALUE_SYNTHESIZE_MODE", False)
...
SIMILAR_SLOT_MODE = _flag("pure_integer_ai_SIMILAR_SLOT_MODE", False)
...
PRONOUN_SLOT_MODE = _flag("pure_integer_ai_PRONOUN_SLOT_MODE", False)
...
MODIFIER_DIRECTION_MODE = _flag("pure_integer_ai_MODIFIER_DIRECTION_MODE", False)
...
SELECTION_PREF_MODE = _flag("pure_integer_ai_SELECTION_PREF_MODE", False)
...
SENSE_LOOKUP_MODE = _flag("pure_integer_ai_SENSE_LOOKUP_MODE", False)
...
SELECTION_PREF_DOCK_MODE = _flag("pure_integer_ai_SELECTION_PREF_DOCK_MODE", False)
...
SELECTION_PREF_FEED_MODE = _flag("pure_integer_ai_SELECTION_PREF_FEED_MODE", False)
...
GENERATE_SELECTION_PREF_MODE = _flag("pure_integer_ai_GENERATE_SELECTION_PREF_MODE", False)
...
DAG_PATH_REACHABLE_SCOPE_MODE = _flag("pure_integer_ai_DAG_PATH_REACHABLE_SCOPE_MODE", False)
...
# default OFF 守 CI·断奶/perf 跑设 pure_integer_ai_STRUCT_REF_CONTENT_HASH_MODE=1（镜像 hotzone env 范式·非 try/finally）。
STRUCT_REF_CONTENT_HASH_MODE = _flag("pure_integer_ai_STRUCT_REF_CONTENT_HASH_MODE", False)
...
ATTACH_SEQ_IDEMPOTENT_MODE = _flag("pure_integer_ai_ATTACH_SEQ_IDEMPOTENT_MODE", False)
...
OUTPUT_LEN_CAP_MODE = _flag("pure_integer_ai_OUTPUT_LEN_CAP_MODE", False)
...
MODE_B_CROSS_VERIFY_MODE = _flag("pure_integer_ai_MODE_B_CROSS_VERIFY_MODE", False)
...
G5_C_CONSOLIDATE_MODE = _flag("pure_integer_ai_G5_C_CONSOLIDATE_MODE", False)
...
COMPOSES_COMBINE_MODE = _flag("pure_integer_ai_COMPOSES_COMBINE_MODE", False)
DIM_BRIDGE_READ_MODE = _flag("pure_integer_ai_DIM_BRIDGE_READ_MODE", False)
...
MEREOLOGY_CLOSURE_MODE = _flag("pure_integer_ai_MEREOLOGY_CLOSURE_MODE", False)
PURE_ALIAS_CLOSURE_MODE = _flag("pure_integer_ai_PURE_ALIAS_CLOSURE_MODE", False)
...
SIMILAR_SECOND_ORDER_MODE = _flag("pure_integer_ai_SIMILAR_SECOND_ORDER_MODE", False)
...
REALIZES_MODE = _flag("pure_integer_ai_REALIZES_MODE", False)
...
CUE_CLUSTER_MODE = _flag("pure_integer_ai_CUE_CLUSTER_MODE", False)
...
ORACLE_PROMOTE_MODE = _flag("pure_integer_ai_ORACLE_PROMOTE_MODE", False)
...
CORRESPONDENCE_SLOT_MODE = _flag("pure_integer_ai_CORRESPONDENCE_SLOT_MODE", False)
...
CUE_SLOT_FILL_MODE = _flag("pure_integer_ai_CUE_SLOT_FILL_MODE", False)
...
SLOT_LCA_CONSTRAINT_MODE = _flag("pure_integer_ai_SLOT_LCA_CONSTRAINT_MODE", False)
...
FLOOR_ACTIVATION_MODE = _flag("pure_integer_ai_FLOOR_ACTIVATION_MODE", False)
...
ACTION_BRIDGE_MODE = _flag("pure_integer_ai_ACTION_BRIDGE_MODE", False)
...
ACTION_BRIDGE_CUE_MODE = _flag("pure_integer_ai_ACTION_BRIDGE_CUE_MODE", False)
...
SYMBOLIC_TRANSFORM_MODE = _flag("pure_integer_ai_SYMBOLIC_TRANSFORM_MODE", False)
...
SYMBOLIC_RELATION_MODE = _flag("pure_integer_ai_SYMBOLIC_RELATION_MODE", False)
...
MEMORY_REPLAY_MODE = _flag("pure_integer_ai_MEMORY_REPLAY_MODE", False)
...
M1_INTENT_CLASSIFY_MODE = _flag("pure_integer_ai_M1_INTENT_CLASSIFY_MODE", False)
...
INTENT_COMMAND_MODE = _flag("pure_integer_ai_INTENT_COMMAND_MODE", False)
...
EXCLUDE_FUNCTION_MODE = _flag("pure_integer_ai_EXCLUDE_FUNCTION_MODE", False)
...
# skeleton ref 就位）经 resolve_struct_bind_pairs 读 pure_integer_ai_LOCAL_DIR/struct_bind_pairs.txt → discovered_operators
...
STRUCT_BIND_BOOT_MODE = _flag("pure_integer_ai_STRUCT_BIND_BOOT_MODE", False)
...
CODE_UNPARSE_MODE = _flag("pure_integer_ai_CODE_UNPARSE_MODE", False)
...
TIME_SEQ_PROOF_MODE = _flag("pure_integer_ai_TIME_SEQ_PROOF_MODE", False)
...
NUMERIC_PROOF_MODE = _flag("pure_integer_ai_NUMERIC_PROOF_MODE", False)
...
UNIVERSAL_PROOF_MODE = _flag("pure_integer_ai_UNIVERSAL_PROOF_MODE", False)
...
EXISTENTIAL_PROOF_MODE = _flag("pure_integer_ai_EXISTENTIAL_PROOF_MODE", False)
...
PROPOSITION_MODE = _flag("pure_integer_ai_PROPOSITION_MODE", False)
...
NEGATION_MODE = _flag("pure_integer_ai_NEGATION_MODE", False)
...
MODALITY_MODE = _flag("pure_integer_ai_MODALITY_MODE", False)
...
DEGREE_MODE = _flag("pure_integer_ai_DEGREE_MODE", False)
...
STATISTICAL_WEANING_MODE = _flag("pure_integer_ai_STATISTICAL_WEANING_MODE", False)

# ---- B4 频次维 observe_tn（方案3 tn路·β_arith 修法·STEP4 P1a）----
# 设计 doc/重来_纠偏轮_round2_任务文档_2026-07-10.md §五 B4 + memory topic
# pure_integer_ai-reboot-step4-b4-freq-p1-arith-collapse-2026-07-10（β_arith 病实测确认·consumer fire 但 w_freq 塌缩）。
...
FREQ_OBSERVE_MODE = _flag("pure_integer_ai_FREQ_OBSERVE_MODE", False)
...
SP_OBSERVE_MODE = _flag("pure_integer_ai_SP_OBSERVE_MODE", False)
...
PRONOUN_RESOLVE_COUNT_MODE = _flag("pure_integer_ai_PRONOUN_RESOLVE_COUNT_MODE", False)
...
COMPARISON_PROOF_MODE = _flag("pure_integer_ai_COMPARISON_PROOF_MODE", False)
...
ORDINAL_SURFACE_MODE = _flag("pure_integer_ai_ORDINAL_SURFACE_MODE", False)
