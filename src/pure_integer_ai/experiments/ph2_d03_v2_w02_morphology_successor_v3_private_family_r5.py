"""R5 私有 family 的纯 metadata freeze 与一次性 guard。"""
...
W02_MORPH_V3_PRIVATE_R5_FAMILY_VERSION = (
    "PH2-D03-V2-W02-MORPHOLOGY-SUCCESSOR-V3-PRIVATE-R5-FAMILY-V1"
)
...
W02_MORPH_V3_PRIVATE_R5_SOURCE_EXTENSION_CODE_PATH = (
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_blind_private_source_extension_v6.py"
)
W02_MORPH_V3_PRIVATE_R5_FAMILY_CODE_PATHS = (
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_io_r5.py",
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_owner_r5_contract.py",
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_owner_r5_audit.py",
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_owner_r5.py",
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_evaluator_r5.py",
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_family_r5.py",
    "src/pure_integer_ai/experiments/"
    "ph2_d03_v2_w02_morphology_successor_v3_private_publication_r5.py",
    "src/pure_integer_ai/experiments/"
    "run_ph2_d03_v2_w02_morphology_successor_v3_private_evaluation_r5.py",
    "tests/test_ph2_d03_v2_w02_morphology_successor_v3_private_owner_r5.py",
    "tests/test_ph2_d03_v2_w02_morphology_successor_v3_private_evaluation_r5.py",
    "tests/test_ph2_d03_v2_w02_morphology_successor_v3_private_family_r5.py",
)
W02_MORPH_V3_PRIVATE_R5_FORMAL_FAMILY_NAME = (
    ".d03-w02-morph-successor-v3-private-formal-r5-20260810-a"
)
W02_MORPH_V3_PRIVATE_R5_FAMILY_DOCUMENT = "private-family-freeze.json"
W02_MORPH_V3_PRIVATE_R5_REGISTRATION_DOCUMENT = (
    "private-family-registration.json"
)
W02_MORPH_V3_PRIVATE_R5_GUARD_AVAILABLE = "run-guard/available.guard.json"
W02_MORPH_V3_PRIVATE_R5_GUARD_CONSUMED = "run-guard/consumed.guard.json"
W02_MORPH_V3_PRIVATE_R5_RUN_INTENT = "run-guard/run-intent.json"
W02_MORPH_V3_PRIVATE_R5_EXPOSURE_LEDGER = "exposure-ledger"


# object-model: exception
class W02MorphologySuccessorV3PrivateR5FamilyError(RuntimeError):
    """R5 公开 freeze、依赖链或一次性 guard 发生漂移。"""
...
def _repository_file(repository: Path, relative: str) -> Path:
    ...
    if (not relative or "\\" in relative or pure.is_absolute()
        ...
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private family repository file is invalid")
    return target
...
def _code_rows(repository: Path) -> tuple[list[dict[str, object]], str]:
    rows = [
        ...
        for relative in W02_MORPH_V3_PRIVATE_R5_FAMILY_CODE_PATHS
    ]
...
def _owner_budget(value: object) -> V2EvaluatorResourceBudget:
    if (not isinstance(value, dict) or set(value) != {
        ...
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 owner resource limits drifted")
...
def _family_root(value: str | Path, *, require_exists: bool) -> Path:
    ...
    if (root.name != W02_MORPH_V3_PRIVATE_R5_FORMAL_FAMILY_NAME
        ...
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private formal family root is invalid")
    return root
...
def _dependency_state(repository: Path) -> dict[str, Any]:
    ...
    source_extension = read_blind_private_source_extension_v6_manifest(repository)
    owner, files = read_w02_morphology_successor_v3_private_owner_r5_receipt(
        repository)
    paths = {
        ...
        "source_extension_v6_code":
            W02_MORPH_V3_PRIVATE_R5_SOURCE_EXTENSION_CODE_PATH,
        "source_extension_v6": BLIND_PRIVATE_SOURCE_EXTENSION_V6_PATH,
        "base_language_adapter_code": BASE_LANGUAGE_ADAPTER_CODE_PATH,
        "base_language_probe_code": BASE_LANGUAGE_PROBE_CODE_PATH,
        "base_language_probe_report": BASE_LANGUAGE_PROBE_REPORT_PATH,
        "consumed_r4_family_freeze": CONSUMED_R4_FAMILY_FREEZE_PATH,
        "consumed_r4_owner_receipt": CONSUMED_R4_OWNER_RECEIPT_PATH,
        "owner_r5_receipt": W02_MORPH_V3_PRIVATE_R5_OWNER_RECEIPT_PATH,
    }
    identities = {
    ...
    probe = read_canonical_object(
        _repository_file(repository, paths["base_language_probe_report"]))
    consumed_r4 = source_extension.get("previous_consumed_r4_family")
    adapter = source_extension.get("public_base_language_family_adapter")
    validate_v2_safe_report(dev)
    validate_v2_safe_report(shadow)
    validate_v2_safe_report(probe)
    if (candidate.get("status") != "W02_CANDIDATE_ARTIFACT_FROZEN"
            ...
            or source_extension.get("consumed_r4_owner_reuse_authorized") != 0
            or not isinstance(consumed_r4, dict)
            or consumed_r4.get("status") != "NE_NO_RECEIPT"
            or consumed_r4.get("formal_private_evaluation_runs") != 1
            or consumed_r4.get("owner_pair_and_label_stream_consumed") != 1
            or consumed_r4.get("source_ref_records_closed_before_pair_stream")
            != 500
            or consumed_r4.get("reuse_authorized") != 0
            or consumed_r4.get("base_candidate_failure")
            != "OBSERVATION_LANGUAGE_LZH_OUT_OF_SCOPE"
            or not isinstance(adapter, dict) or adapter.get("status") != "PASS"
            or adapter.get("base_prediction_metamorphic_equal") != 1
            or adapter.get("route_original_lzh_authorized") != 1
            or adapter.get("route_adapted_zh_authorized") != 0
            or probe.get("status") != "PASS"
            or probe.get("source_language") != "lzh"
            or probe.get("base_scope_language") != "zh"
            or probe.get("base_prediction_metamorphic_equal") != 1
            or probe.get("route_original_lzh_authorized") != 1
            or probe.get("route_adapted_zh_authorized") != 0
            or owner.get("status")
            ...
            != W02_MORPH_V3_PRIVATE_R5_METADATA_SHA256
            or owner.get("pair_count") != 500
            or owner.get("source_count") != 500
            or tuple(row.layout_key for row in files)
            != W02_MORPH_V3_PRIVATE_LAYOUTS):
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private family dependency chain did not close")
    zero_values = (
        ...
        probe.get("formal_private_evaluation_runs"),
        owner.get("formal_private_evaluation_runs"),
        owner.get("main_session_private_payload_reads"),
        owner.get("main_session_source_payload_reads"),
    )
    if any(value != 0 for value in zero_values):
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private dependency already consumed private data")
    chain = {
        "base_language_adapter_code_file_sha256":
            identities["base_language_adapter_code"]["sha256"],
        "base_language_probe_code_file_sha256":
            identities["base_language_probe_code"]["sha256"],
        "base_language_probe_report_file_sha256":
            identities["base_language_probe_report"]["sha256"],
        ...
        "consumed_r4_family_freeze_file_sha256":
            identities["consumed_r4_family_freeze"]["sha256"],
        "consumed_r4_owner_receipt_file_sha256":
            identities["consumed_r4_owner_receipt"]["sha256"],
        "owner_family_key": owner["owner_family_key"],
        "owner_metadata_sha256": owner["owner_metadata_sha256"],
        "owner_r5_receipt_file_sha256":
            identities["owner_r5_receipt"]["sha256"],
        "source_extension_v6_file_sha256":
            identities["source_extension_v6"]["sha256"],
        "source_extension_v6_code_file_sha256":
            identities["source_extension_v6_code"]["sha256"],
...
def w02_morphology_successor_v3_private_r5_guard_value(
        *, family_commitment: str, artifact_chain_sha256: str,
        code_freeze_sha256: str) -> dict[str, object]:
    return {
        "artifact_chain_sha256": _sha256(
            artifact_chain_sha256, where="R5 private artifact chain"),
        "artifact_kind": (
            "PH2_D03_V2_W02_MORPHOLOGY_SUCCESSOR_V3_PRIVATE_R5_"
            "FIRST_RUN_GUARD"),
        "code_freeze_sha256": _sha256(
            code_freeze_sha256, where="R5 private code freeze"),
        "family_commitment": _sha256(
            family_commitment, where="R5 private family commitment"),
        "formal_private_evaluation_runs": 0,
        "format_version": 1,
        "guard_consumed": 0,
        "guard_version": W02_MORPH_V3_PRIVATE_R5_FAMILY_VERSION,
...
def build_w02_morphology_successor_v3_private_r5_family_freeze(
    ...
    budget = _owner_budget(owner["resource_limits"])
    ...
    guard = w02_morphology_successor_v3_private_r5_guard_value(
        family_commitment=registration.family_commitment,
        artifact_chain_sha256=dependency["artifact_chain_sha256"],
        code_freeze_sha256=code_sha,
    )
    files = dependency["files"]
    consumed_r4 = source_extension["previous_consumed_r4_family"]
    adapter = source_extension["public_base_language_family_adapter"]
    return {
        ...
        "artifact_kind": (
            "PH2_D03_V2_W02_MORPHOLOGY_SUCCESSOR_V3_PRIVATE_R5_"
            "FAMILY_FREEZE"),
        "artifact_version": W02_MORPH_V3_PRIVATE_R5_FAMILY_VERSION,
        "base_language_adapter": dict(adapter),
        "code_files": code_rows,
        "code_freeze_sha256": code_sha,
        "dimension_denominator_counts": owner["dimension_denominator_counts"],
        "evaluator_version": W02_MORPH_V3_PRIVATE_R5_EVALUATOR_VERSION,
        ...
        "ne_policy": "BLOCK",
        "next_action": "W02_FORMAL_BLIND_PRIVATE_R5_EVALUATION",
        ...
        "owner_receipt_file_sha256":
            dependency["identities"]["owner_r5_receipt"]["sha256"],
        ...
        "parent_evidence_files": [
            ...
            for key in (
                ...
                "v3_shadow_report", "source_extension_v6_code",
                "source_extension_v6", "base_language_adapter_code",
                "base_language_probe_code", "base_language_probe_report",
                "consumed_r4_family_freeze", "consumed_r4_owner_receipt",
                "owner_r5_receipt",
            )
        ],
        "previous_consumed_r2_reuse_authorized": 0,
        "previous_consumed_r3_reuse_authorized": 0,
        "previous_consumed_r4": dict(consumed_r4),
        "previous_consumed_r4_reuse_authorized": 0,
        ...
        "stage_key": "W-02",
        "status": "W02_SUCCESSOR_V3_R5_BLIND_PRIVATE_FAMILY_FROZEN",
...
def publish_w02_morphology_successor_v3_private_r5_family_freeze(
        repository_root: str | Path) -> Path:
    repository = Path(repository_root).resolve()
    value = build_w02_morphology_successor_v3_private_r5_family_freeze(
        repository)
    target = repository / Path(*PurePosixPath(
        W02_MORPH_V3_PRIVATE_R5_FAMILY_FREEZE_PATH).parts)
    write_immutable_json(value, target)
    if target.read_bytes() != canonical_json_bytes(value) + b"\n":
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private family freeze publication drifted")
    return target


def read_w02_morphology_successor_v3_private_r5_family_freeze(
        repository_root: str | Path) -> dict[str, object]:
    repository = Path(repository_root).resolve()
    target = _repository_file(
        repository, W02_MORPH_V3_PRIVATE_R5_FAMILY_FREEZE_PATH)
    value = read_canonical_object(target)
    expected = build_w02_morphology_successor_v3_private_r5_family_freeze(
        repository)
    if value != expected or target.read_bytes() != canonical_json_bytes(value) + b"\n":
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private family freeze no longer matches live identities")
    return value


def w02_morphology_successor_v3_private_r5_registration_from_freeze(
    ...
    if not isinstance(registration, dict) or not isinstance(budget, dict):
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private family registration fields are invalid")
    ...
    if rebuilt.to_dict() != registration:
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private family registration canonical value drifted")
    return rebuilt


def publish_w02_morphology_successor_v3_private_r5_family_root(
        repository_root: str | Path, family_root: str | Path) -> str:
    repository = Path(repository_root).resolve()
    freeze = read_w02_morphology_successor_v3_private_r5_family_freeze(
        repository)
    registration = (
        w02_morphology_successor_v3_private_r5_registration_from_freeze(
            freeze))
    root = _family_root(family_root, require_exists=False)
    if root.exists():
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private formal family root already exists")
    root.mkdir(parents=False, exist_ok=False)
    write_immutable_json(
        registration.to_dict(),
        root / W02_MORPH_V3_PRIVATE_R5_REGISTRATION_DOCUMENT)
    write_immutable_json(freeze, root / W02_MORPH_V3_PRIVATE_R5_FAMILY_DOCUMENT)
    (root / W02_MORPH_V3_PRIVATE_R5_EXPOSURE_LEDGER).mkdir(exist_ok=False)
    guard = w02_morphology_successor_v3_private_r5_guard_value(
        family_commitment=registration.family_commitment,
    ...
    target = root / Path(*PurePosixPath(
        W02_MORPH_V3_PRIVATE_R5_GUARD_AVAILABLE).parts)
    write_immutable_json(guard, target)
    digest = hashlib.sha256(target.read_bytes()).hexdigest()
    if digest != freeze["first_run_guard_sha256"]:
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private available guard SHA drifted")
    return digest


def w02_morphology_successor_v3_private_r5_run_identity(
        freeze: dict[str, object], family_freeze_sha256: str) -> str:
    registration = freeze.get("registration")
    if not isinstance(registration, dict):
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private run registration is missing")
    return hashlib.sha256(canonical_json_bytes({
        ...
        "family_freeze_sha256": _sha256(
            family_freeze_sha256, where="R5 private family freeze"),
...
def _intent_value(
    ...
    return {
        "artifact_kind": (
            "PH2_D03_V2_W02_MORPHOLOGY_SUCCESSOR_V3_PRIVATE_R5_RUN_INTENT"),
        "formal_private_evaluation_runs": 1,
        "guard_sha256": _sha256(guard_sha256, where="R5 private guard"),
        "private_payload_reads_before_guard": 0,
        "run_id": 1,
        "run_identity_sha256": _sha256(
            run_identity_sha256, where="R5 private run identity"),
        "stage_key": "W-02",
        "status": "RUN_INTENT_COMMITTED_BEFORE_PRIVATE_READ",
    }


def consume_w02_morphology_successor_v3_private_r5_guard(
    ...
    consumed = root / Path(*PurePosixPath(
        W02_MORPH_V3_PRIVATE_R5_GUARD_CONSUMED).parts)
    intent = root / Path(*PurePosixPath(
        W02_MORPH_V3_PRIVATE_R5_RUN_INTENT).parts)
    if consumed.exists() or intent.exists() or not available.is_file():
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private guard is unavailable or already consumed")
    if _sha256_file(available)[1] != _sha256(
            expected_guard_sha256, where="expected R5 private guard"):
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private available guard bytes drifted")
...
def verify_w02_morphology_successor_v3_private_r5_consumed_guard(
        family_root: str | Path, *, expected_guard_sha256: str,
        run_identity_sha256: str) -> None:
    root = _family_root(family_root, require_exists=True)
    available = root / Path(*PurePosixPath(
    ...
    if available.exists() or not consumed.is_file() or not intent.is_file():
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private consumed guard state is incomplete")
    if (_sha256_file(consumed)[1] != expected_guard_sha256
            or read_canonical_object(intent) != _intent_value(
                guard_sha256=expected_guard_sha256,
                run_identity_sha256=run_identity_sha256)):
        raise W02MorphologySuccessorV3PrivateR5FamilyError(
            "R5 private consumed guard or run intent drifted")


__all__ = [
    "W02_MORPH_V3_PRIVATE_R5_EXPOSURE_LEDGER",
    "W02_MORPH_V3_PRIVATE_R5_FAMILY_CODE_PATHS",
    "W02_MORPH_V3_PRIVATE_R5_FAMILY_DOCUMENT",
    "W02_MORPH_V3_PRIVATE_R5_FAMILY_FREEZE_PATH",
    "W02_MORPH_V3_PRIVATE_R5_FAMILY_VERSION",
    "W02_MORPH_V3_PRIVATE_R5_FORMAL_FAMILY_NAME",
    "W02_MORPH_V3_PRIVATE_R5_GUARD_AVAILABLE",
    "W02_MORPH_V3_PRIVATE_R5_GUARD_CONSUMED",
    "W02_MORPH_V3_PRIVATE_R5_REGISTRATION_DOCUMENT",
    "W02_MORPH_V3_PRIVATE_R5_RUN_INTENT",
    ...
    "publish_w02_morphology_successor_v3_private_r5_family_freeze",
    ...
    "w02_morphology_successor_v3_private_r5_guard_value",
    "w02_morphology_successor_v3_private_r5_registration_from_freeze",
