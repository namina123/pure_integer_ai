...
W08_EXPECTED_COMMITMENTS = {
    ...
    "inference_state": (
        220, 174, 59, 15, 0, 126, 143, 60, 219, 165, 58, 131, 112, 233,
        85, 99, 99, 107, 10, 219, 110, 198, 76, 196, 125, 28, 192, 190,
        105, 130, 15, 58,
    ),
    "retention": (
    ...
    "semantic_state": (
        147, 87, 94, 21, 175, 183, 40, 113, 1, 112, 17, 12, 140, 221,
        227, 225, 5, 149, 212, 225, 99, 156, 41, 24, 101, 146, 7, 243,
        32, 39, 203, 74,
    ),
    "uses": (
