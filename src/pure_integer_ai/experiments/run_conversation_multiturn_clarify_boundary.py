...
from pure_integer_ai.experiments.conversation_multiturn_clarify_boundary import (
    build_clarify_boundary_report,
    write_clarify_boundary_report,
)


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="real clarify boundary slice")
    ...
    report = build_clarify_boundary_report(
    ...
    output = write_clarify_boundary_report(report, args.output)
    print(json.dumps({
        "output": output,
