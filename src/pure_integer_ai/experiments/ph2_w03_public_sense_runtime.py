...
PUBLIC_W03_SENSE_ARTIFACT_V4_RELATIVE_PATH = Path(
    "data/ph2/w03_public_sense_runtime_v4.json")
PUBLIC_W03_SENSE_ARTIFACT_V4 = (
    REPOSITORY / PUBLIC_W03_SENSE_ARTIFACT_V4_RELATIVE_PATH)
...
def _artifact_identity(
    ...
    if artifact_version == "v4":
        return (
            PUBLIC_W03_SENSE_ARTIFACT_V4,
            PUBLIC_W03_SENSE_ARTIFACT_V4_RELATIVE_PATH,
            PUBLIC_W03_SENSE_ARTIFACT_V4_SHA256,
            4,
        )
